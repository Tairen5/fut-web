          ...
          <>
            <div className="sidebar-user">
              <div className="sidebar-user-avatar">
                <span>{(user.discordUsername || 'U')[0].toUpperCase()}</span>
              </div>
              <div className="sidebar-user-info">
                <span className="sidebar-user-name">{user.discordUsername || 'User'}</span>
                <div className="sidebar-currencies">
                  <span className="sidebar-currency gold">{user.currency?.toLocaleString() || '0'}</span>
                </div>
              </div>
            </div>
